    ...
    <div class="login">
        <div class="innerlogin" align="center">
            ...
            <form action="Ssignup" method="post">
               <div>
                        <input placeholder="Email" id="email" name="txtemail" type="email"  class="input-field" required />
                    </div>
                   <div>
                            <input placeholder="Name" id="ans2" name="txtname" type="text"  class="input-field" required />
                        </div>
                    <div>
                        <input placeholder="Password" id="password" name="txtpassword" title="Password must contain at least 6 characters, including UPPER/lowercase and numbers." required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" type="password"  class="input-field">
                    </div>
                    <div>
                        <input placeholder="Re-type Password" id="password2" name="txtpassword2" title="Please enter the same Password as above." type="password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"  class="input-field">
                    </div>
