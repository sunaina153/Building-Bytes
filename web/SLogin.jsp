        ...
        <div class="innerlogin" align="center">
            ...
            <form action="SLoginServlet" method="post">
                <div>
                    ...
                    <div>
                        <input placeholder="Password" id="password" class="input-field" name="password" type="password" required="required" data-validation-required-message="Please enter your password.">
                    </div>
                    <div class="link">
                        <button type="submit" class="button">Login</button><br>
                        <a href="SForgotPass.jsp" class="forgot">Forgot Password?</a>
                    </div>
            </form>
                <div class="newuser">
...
<div class="mySlides fade">
  ...
  <img src="images/Slide1.JPG" style="width:600px">
</div>

<div class="mySlides fade">
  <div class="numbertext"></div>
  <img src="images/Slide2.JPG" style="width:600px">
</div>

<div class="mySlides fade">
  <div class="numbertext"></div>
  <img src="images/Slide12.JPG" style="width:600px">
</div>
            
<div class="mySlides fade">
  <div class="numbertext"></div>
  <img src="images/Slide13.JPG" style="width:600px">
</div>
            
<div class="mySlides fade">
  <div class="numbertext"></div>
  <img src="images/Slide14.JPG" style="width:600px">
</div>
            
<div class="mySlides fade">
  <div class="numbertext"></div>
  <img src="images/Slide16.JPG" style="width:600px">
</div>
